...
const mediaData = {
  media: [
    [
      {
        type: "image",
        src: "Images/Reviews/First-review/woman-with-a-smile.jpg",
        alt: "Фотография девушки",
      },
      {
        type: "image",
        src: "Images/Reviews/First-review/woman-with-a-smile-(2).jpg",
        alt: "",
      },
      {
        type: "image",
        src: "Images/Reviews/First-review/woman-with-a-smile-(3).jpg",
        alt: "",
      },
      {
        type: "image",
        src: "Images/Reviews/First-review/woman-with-a-smile-(4).jpg",
        alt: "",
      },
      {
        type: "image",
        src: "Images/Reviews/First-review/woman-with-a-smile-(5).jpg",
        alt: "",
      },
      {
        type: "image",
        src: "Images/Reviews/First-review/woman-with-a-smile-(6).jpg",
        alt: "",
      },
    ],
    [
      {
        type: "video",
        src: "Images/Reviews/Second-review/girl.MOV",
        alt: "Видео с девочкой",
      },
      {
        type: "video",
        src: "Images/Reviews/Second-review/family.MOV",
        alt: "",
      },
      {
        type: "image",
        src: "Images/Reviews/Second-review/family-(2).jpg",
        alt: "",
      },
      {
        type: "image",
        src: "Images/Reviews/Second-review/girl-(2).jpg",
        alt: "",
      },
      {
        type: "image",
        src: "Images/Reviews/Second-review/brother-and-sister.jpg",
        alt: "",
      },
      {
        type: "image",
        src: "Images/Reviews/Second-review/woman-and-a-car.jpg",
        alt: "",
      },
    ],
    [
      {
        type: "image",
        src: "Images/Reviews/Third-review/girl.jpg",
        alt: "Фотография девушки",
      },
      {
        type: "image",
        src: "Images/Reviews/Third-review/girl-(2).jpg",
        alt: "",
      },
      {
        type: "image",
        src: "Images/Reviews/Third-review/girl-(3).jpg",
        alt: "",
      },
      {
        type: "image",
        src: "Images/Reviews/Third-review/girl-(4).jpg",
        alt: "",
      },
      {
        type: "image",
        src: "Images/Reviews/Third-review/girl-(5).jpg",
        alt: "",
      },
      {
        type: "image",
        src: "Images/Reviews/Third-review/girl-(6).jpg",
        alt: "",
      },
    ],
    [
      {
        type: "video",
        src: "Images/Reviews/Fourth-review/bride.MOV",
        alt: "Видео: невеста в соборе",
      },
      {
        type: "video",
        src: "Images/Reviews/Fourth-review/bride-(2).mp4",
        alt: "",
      },
      {
        type: "image",
    ...
    [
      {
        type: "image",
        src: "Images/Reviews/Fifth-review/green-family.jpg",
        alt: "Семья на берегу",
      },
      {
        type: "image",
        src: "Images/Reviews/Fifth-review/green-family-(2).jpg",
        alt: "",
      },
      {
        type: "image",
        src: "Images/Reviews/Fifth-review/green-family-(3).jpg",
        alt: "",
      },
      {
        type: "image",
        src: "Images/Reviews/Fifth-review/green-family-(4).jpg",
        alt: "",
      },
    ],
    [
      {
        type: "image",
        src: "Images/Reviews/Sixth-review/family.jpg",
        alt: "Отец с сыном",
      },
      {
        type: "image",
        src: "Images/Reviews/Sixth-review/family-(2).jpg",
        alt: "",
      },
      {
        type: "image",
        src: "Images/Reviews/Sixth-review/family-(3).jpg",
        alt: "",
      },
      {
        type: "image",
        src: "Images/Reviews/Sixth-review/man.jpg",
        alt: "Мужик",
      },
      {
        type: "image",
        src: "Images/Reviews/Sixth-review/man-(2).jpg",
        alt: "",
      },
      {
        type: "image",
        src: "Images/Reviews/Sixth-review/man-(3).jpg",
        alt: "",
      },
    ],
  ],
...
function moveToPrevPhoto() {
  const currentMedia = mediaData.media[currentIndex];
  currentPhotoIndex =
    (currentPhotoIndex - 1 + currentMedia.length) % currentMedia.length;
  updatePhotoDisplay();
}
...
scrollArrow.addEventListener("click", function () {
  ...
  socialReviews.style.transform = isExpanded
    ? "translateX(-50vw)"
    : "translateX(0)"; // Перемещение влево
  textElement.style.opacity = isExpanded ? "0" : "1";
  textElement.style.transform = isExpanded
    ? "translateX(-30vw)"
    : "translateX(0)";
  // Прокручиваем влево
  ...
  this.style.transform = isExpanded
    ? "translateX(-50vw) rotate(180deg)"
...
for (let review of reviews) {
  review.addEventListener("click", function () {
    ...
    textElement.style.transform = isExpanded
      ? "translateX(-30vw)"
      : "translateX(0)";
    scrollArrow.style.transform = isExpanded
      ? "translateX(-50vw) rotate(180deg)"
      : "translateX(0) rotate(0deg)";
    // Прокрутка
    socialReviews.scrollBy({
...
scrollArrow.addEventListener("mouseout", function () {
  this.style.textShadow =
    "-1px -1px 2px rgba(0, 0, 0, 0.5), 1px -1px 2px rgba(0, 0, 0, 0.5), -1px 1px 2px rgba(0, 0, 0, 0.5), 1px 1px 2px rgba(0, 0, 0, 0.5)";
});
