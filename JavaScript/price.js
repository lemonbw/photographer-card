const slidesData = {
    portrait: [
        { type: 'video', src: 'Images/Price/Portrait/agirliswalkingdownthestreet.MOV', alt: 'Девушка ходит по улице'},
        ...
        { type: 'image', src: 'Images/Price/Portrait/girlinthehay.jpg', alt: 'Девушка на сене'},
        { type: 'image', src: 'Images/Price/Portrait/girlontherailway.jpg', alt: 'Девушка на железной дороге'},
    ],
    family: [
    ...
    animals: [
        { type: 'image', src: 'Images/Price/Animals/girlwithhorse.jpg', alt: 'Девушка и лошадь'},
        ...
        { type: 'image', src: 'Images/Price/Animals/a-dog.jpg', alt: 'Фотография собаки'},
