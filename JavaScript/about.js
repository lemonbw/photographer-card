    ...
    reasons: [
        {
            ...
            description: "Я обладаю креативным взглядом на мир, и мои работы отличаются глубиной и искренностью. Вы получите результат, который поразит вас и ваших близких."
        },
        {
            id: "second-reason",
            icon: "Images/About/icon-business-woman.svg",
            title: "Профессионализм",
            description: "Вы можете не сомневаться, что каждая фотография будет сделана с безупречным мастерством и вниманием к деталям. Я гарантирую высокое качество снимков, которые станут драгоценными воспоминаниями на всю жизнь."
        },
        {
            id: "third-reason",
            icon: "Images/About/icon-individual.svg",
            title: "Индивидуальный подход",
            description: "Я понимаю, что каждый клиент уникален, и поэтому воплощаю в жизнь даже самые смелые идеи. Вы получите фотографии, отражающие вашу индивидуальность и уникальность момента."
        },
        {
            id: "fourth-reason",
            icon: "Images/About/diversity.svg",
            title: "Широкий спектр услуг",
            description: "От семейных и свадебных фотосессий до корпоративных мероприятий и рекламных проектов — я владею разнообразными стилями и техниками, чтобы создать идеальные фотографии в любой ситуации. Вам не придется искать других мобилографов, так как я обладаю всеми необходимыми навыками."
        }
    ]
};
